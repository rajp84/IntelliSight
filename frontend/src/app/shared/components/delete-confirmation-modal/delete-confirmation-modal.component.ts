              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  ...
                  <div class="mt-4 text-sm text-gray-700">
                    <p class="font-medium">This will permanently remove:</p>
                    <ul class="mt-2 list-disc list-inside space-y-1">
                      <li>Training record from database</li>
                      <li>All embeddings and collections</li>
                      <li>All associated images</li>
                    </ul>
                    <p class="mt-2 font-medium text-red-600">This action cannot be undone.</p>
                  </div>
                </div>
              </div>
            </div>
...
export class DeleteConfirmationModalComponent {
  @Input() isOpen = false;
  @Input() title = 'Delete Training Run';
  @Input() message = 'Are you sure you want to delete this training run?';
